...
* `tabshiftr` reliably reorganises a wide and growing range of table arrangements, but new dimensions of disorganisation can always show up. If you encounter a table that the current infrastructure can't handle, please open an issue or get in touch — we are happy to collaborate on extending the package.
