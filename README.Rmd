...
3. Determine which variable identifies clusters and provide that as cluster ID. It may be that either an identifying variable, or a values variable identifies clusters. In case it is an identifying variable, provide this variables' name (and also register its metadata) and if it's a values variable, provide simply `"values"` as cluster ID. Think *which variable is split up into clusters?*
