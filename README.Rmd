...
*(topologically) coherent table*: A (rectangular) table contains no gaps (see tidy table).
...
*disorganised (messy) table*: A table that contains any sort of non-tidy data, specifically emphasizing that those may also be tables that contain (messy) clusters or other forms of loosely/non-coherently organised data.
